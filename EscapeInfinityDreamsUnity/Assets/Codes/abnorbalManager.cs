...
public class abnorbalManager : MonoBehaviour
{
	...
	public void Init()
	{
		...
		Light2D GlobalLight = abnormals[22].GetComponent<Light2D>();
		//이상현상 오브젝트 리스트을 돌아보며
	...
	public void nextStage()
	{
		...
		else if (ranIdx == 24) //플레이어 이동 속도 변화
		{
		...
		else if (ranIdx == 25) //플레이어, 고양이 그림자 삭제
		{
